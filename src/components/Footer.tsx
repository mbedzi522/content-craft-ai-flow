          ...
          <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <Link to="/examples" className="text-sm text-gray-400 hover:text-white">
                    Examples
                  </Link>
                </li>
                <li>
                  <Link to="/trading-post" className="text-sm text-gray-400 hover:text-white">
                    Trading Post
                  </Link>
                </li>
                <li>
                  <Link to="/tiktok" className="text-sm text-gray-400 hover:text-white">
                    TikTok Strategy
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <Link to="/community" className="text-sm text-gray-400 hover:text-white">
                    Community
                  </Link>
                </li>
                <li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="flex">
                <Input
                  ...
                  className="bg-secondary/50 border-border rounded-r-none"
                />
                <Button className="rounded-l-none bg-brand-purple hover:bg-brand-purple/90">
            ...
            <div className="text-right md:text-right">
              <p className="text-sm text-gray-400">
                &copy; {new Date().getFullYear()} ContentCraftAI. All rights reserved.
              </p>
            </div>
          </div>
        </div>
